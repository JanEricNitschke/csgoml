...
def on_modified(event):
    ...
    if not os.path.exists(path):
        ...
        logging.info(
            "Calling analyter_sorter: analyzer = demo_analyzer_sorter.DemoAnalyzerSorter(indentation=True,dirs=[%s],log=None,maps_dir='E:\\PhD\\MachineLearning\\CSGOData\\test',json_ending=%s)",
            path,
            ending,
        )
